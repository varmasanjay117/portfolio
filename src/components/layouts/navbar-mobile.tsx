...
export function NavbarMobile() {
  ...
  return (
    <>
      {isOpen && (
        <div className="absolute top-[57px] left-0 bg-background h-[calc(100%-57px-27px)] w-full z-50 p-5 divide-y overflow-y-auto">
          {navMenu.map((menu, i) => (
            <Fragment key={i}>
              {menu.child ? (
...
export const navMenu = [
  ...
  },
  {
    ...
    child: [
      {
        name: 'Email',
        path: 'mailto:varma.sanjay117@gmail.com',
      },
      {
        name: 'LinkedIn',
        path: 'https://www.linkedin.com/in/sanjay-varma-20284215a/',
      },
      {
        name: 'Instagram',
      ...
      {
        name: 'Twitter',
        path: 'https://twitter.com/VarmaSanjay117',
      },
    ],
  },
];
